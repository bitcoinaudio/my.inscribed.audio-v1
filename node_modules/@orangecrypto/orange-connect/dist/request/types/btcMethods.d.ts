...
type RecipientWithTicker = {
    ...
    amount: number;
    /**
     * The token ticker for tx used in brc20 and rune tx.
     */
    ticker: string;
};
type SendTransferParamsAlt = {
    /**
     * Recipient object to send to.
     * The amount to send to each recipient is in satoshis.
     */
    recipient: RecipientWithTicker;
};
export type SendBrc20OneStep = MethodParamsAndResult<SendTransferParamsAlt, SendTransferResult>;
export type SendRune = MethodParamsAndResult<SendTransferParamsAlt, SendTransferResult>;
